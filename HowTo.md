...
On peut s'inspirer de `/etc/systemd/system/dbus-fi.w1.wpa_supplicant1.service` par exemple pour démarrer u service avant le réseau.


<!--stackedit_data:
eyJoaXN0b3J5IjpbMTI0NDA3MTYzLC0zOTkzODMzMzRdfQ==
-->